...
import {demoDefaultPage_TREE, demoDefaultBody_TREE} from './params_tree';

export default class business_demo_tree extends BasePlugin {
  static id = 'business_demo_tree';
  // 关联渲染器名字
  rendererName = 'page';
  ...
  scaffold: any = demoDefaultPage_TREE;
  previewSchema: any = {
    type: 'page',
