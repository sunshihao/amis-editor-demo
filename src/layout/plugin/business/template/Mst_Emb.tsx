...
import {demoDefaultPage_MST_EMB, demoDefaultBody_MST_EMB} from '../params/params_emb';

export default class template_mst_emb extends BasePlugin {
  static id = 'template_mst_emb';
  // 关联渲染器名字
  rendererName = 'page';
